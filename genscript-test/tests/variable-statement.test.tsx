...
test("var:statement renders correctly with const", () => {
  const v = (
    <var:statement>
...
test("var:statement renders correctly with let", () => {
  const v = (
    <var:statement>
...
test("var:statement renders correctly with var", () => {
  const v = (
    <var:statement>
...
test("var:statement renders correctly with a multiple declarations", () => {
  const v = (
    <var:statement>
      <var:declaration-list type="const">
        <var:declaration>
...
test("var:statement renders correctly with non-identifier bindings", () => {
  const v = (
    <var:statement>
      <var:declaration-list type="const">
        <var:declaration>
